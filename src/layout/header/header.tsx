...
const SubHeader = () => {
  ...
  return (
    <Header>
      <Menu triggerSubMenuAction="click" onOpenChange={() => setIsOpen(!isOpen)} className="header__container"
            theme="dark" mode="horizontal" defaultSelectedKeys={currentScreenKey} selectedKeys={currentScreenKey}>
        ...
        <SubMenu key="sub1" className="header__menu"
                 title={<span className="header__item">Account{isOpen ? <UpOutlined className="header__up"/> :
                   <DownOutlined className="header__up"/>}</span>}
