  ...
  return (
    <Header>
      <Menu
        ...
        theme="dark"
        mode="horizontal"
        defaultSelectedKeys={currentScreenKey}
        selectedKeys={currentScreenKey}
      >
        <Menu.Item key="1" onClick={() => dispatch(setCurrentScreen('1'))}>
          <Link to="/my-tests">
            <span className="header__item">My Tests</span>
          </Link>
        </Menu.Item>
        <Menu.Item key="2" onClick={() => dispatch(setCurrentScreen('2'))}>
          <Link to="/candidates">
            <span className="header__item">Candidates</span>
          </Link>
        </Menu.Item>
        <Menu.Item key="3" onClick={() => dispatch(setCurrentScreen('3'))}>
          <Link to="/questions">
            <span className="header__item">Questions</span>
          </Link>
        </Menu.Item>
        <SubMenu
          key="sub1"
          ...
          title={
            <span className="header__item">
              Account
              {isOpen ? (
                <UpOutlined className="header__up" />
              ) : (
                <DownOutlined className="header__up" />
              )}
            </span>
          }
          popupClassName="header__background"
          onTitleClick={() => dispatch(setCurrentScreen(''))}
        >
          <Menu.Item key="4">
